...
class ChatPosterScreen extends StatefulWidget {
  String postId;
  String memberId;
  ChatPosterScreen({super.key, required this.memberId, required this.postId});

  @override
  State<ChatPosterScreen> createState() => _ChatPosterScreenState();
}

class _ChatPosterScreenState extends State<ChatPosterScreen> {
